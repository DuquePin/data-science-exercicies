...
def main():
    if len(sys.argv) > 1:
        months = sys.argv[1:]
        months = [item.upper() for item in months]
...
def gen_plots(selected_months):
    ...
    dataset = pd.read_csv('main/Mod_14/input/SINASC_RO_2019.csv')
    ...
    if not os.path.exists("main/Mod_14/output"):
        os.makedirs("main/Mod_14/output")
    ...
    for month in selected_months:
        ...
        plt.savefig('main/Mod_14/output/plot_{}.png'.format(month))
